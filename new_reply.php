...
<div class="box">
	<div class="box_left">
    	<a id="forum_a" href="<?php echo $url_home; ?>">Forum Index</a> &gt; <a id="forum_a" href="list_topics.php?parent=<?php echo $dn1['parent']; ?>"><?php echo htmlentities($dn1['name'], ENT_QUOTES, 'UTF-8'); ?></a> &gt; <a id="forum_a" href="read_topic.php?id=<?php echo $id; ?>"><?php echo htmlentities($dn1['title'], ENT_QUOTES, 'UTF-8'); ?></a> &gt; Add a reply
    </div>
	<div class="box_right">
...
if(isset($_POST['message']) and $_POST['message']!='')
{
	...
	<a id="forum_a" href="read_topic.php?id=<?php echo $id; ?>">Go to the topic</a></div>
	<?php
	}
	else
	{
